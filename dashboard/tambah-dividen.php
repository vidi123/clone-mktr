<?php
  ...
  if(isset($_POST["submit"])){
    // var_dump($_POST);
    echo strlen($_POST["jenis-dividen"]);
    ...
    $sql = "INSERT INTO dividen VALUES (NULL, '$jenis', '$distribusi', '$nilai');";
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        <h1>Tambah Data Dividen</h1>
        <form action="" method="post">
          <div class="input-wrap">
            <label for="jenis-dividen">Jenis Dividen</label>
            <input type="text" name="jenis-dividen" id="jenis-dividen" autocomplete="off"/>
          </div>
          <div class="input-wrap">
            <label for="distribusi">Distribusi</label>
            <input type="text" name="distribusi" id="distribusi" autocomplete="off"/>
          </div>
          <div class="input-wrap">
            <label for="nilai-saham">Nilai Saham</label>
            <input type="number" name="nilai-saham" id="nilai-saham" autocomplete="off"/>
          </div>
