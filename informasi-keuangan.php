  ...
  <head>
    ...
    <style>
      ...
      * {
      ...
      .nav-desktop .drop-wrap ul li span.info-keuangan {
        color: #ffc050;
      }
      ...
      .container section .content > .grafik iframe {
        width: 100%;
        height: 400px;
      }
      ...
      .container section .content .file {
        display: flex;
        flex-direction: column;
        align-items: center;
        gap: 15px;
      }
      .container section .content .file .file-img {
        width: 50%;
      }
      .container section .content .file .file-img img {
        width: 100%;
      }
    ...
    <div class="container">
        ...
        <div class="content">
          <div class="grafik">
            <iframe
              ...
              allowtransparency="true"
              frameborder="0"
              src="https://www.tradingview-widget.com/embed-widget/symbol-overview/?locale=id#%7B%22symbols%22%3A%5B%5B%22Kelapa%20Sawit%22%2C%22IDX%3AMKTR%7C3M%22%5D%5D%2C%22chartOnly%22%3Afalse%2C%22width%22%3A1050%2C%22height%22%3A400%2C%22colorTheme%22%3A%22light%22%2C%22showVolume%22%3Afalse%2C%22showMA%22%3Afalse%2C%22hideDateRanges%22%3Atrue%2C%22hideMarketStatus%22%3Afalse%2C%22hideSymbolLogo%22%3Afalse%2C%22scalePosition%22%3A%22right%22%2C%22scaleMode%22%3A%22Normal%22%2C%22fontFamily%22%3A%22Arial%2C%20sans-serif%22%2C%22fontSize%22%3A%2214%22%2C%22noTimeScale%22%3Afalse%2C%22valuesTracking%22%3A%221%22%2C%22changeMode%22%3A%22price-and-percent%22%2C%22chartType%22%3A%22candlesticks%22%2C%22backgroundColor%22%3A%22rgba(255%2C%20255%2C%20255%2C%201)%22%2C%22upColor%22%3A%22rgba(27%2C%2094%2C%2032%2C%201)%22%2C%22downColor%22%3A%22rgba(255%2C%20167%2C%2038%2C%201)%22%2C%22borderUpColor%22%3A%22rgba(27%2C%2094%2C%2032%2C%201)%22%2C%22borderDownColor%22%3A%22rgba(255%2C%20167%2C%2038%2C%201)%22%2C%22wickUpColor%22%3A%22rgba(27%2C%2094%2C%2032%2C%201)%22%2C%22wickDownColor%22%3A%22rgba(255%2C%20167%2C%2038%2C%201)%22%2C%22utm_source%22%3A%22mktr.co.id%22%2C%22utm_medium%22%3A%22widget%22%2C%22utm_campaign%22%3A%22symbol-overview%22%2C%22page-uri%22%3A%22mktr.co.id%2Findex.php%2Finformasi-keuangan%2F%23HARGASAHAM%22%7D"
      ...
      <section id="LT">
        ...
        <div class="content">
          <div class="deskripsi">
            <p>
              Sebagai perusahaan yang menjunjung tinggi prinsip-prinsip
              keterbukaan dan akuntabilitas, kami memiliki fokus untuk membangun
              pelaporan perusahaan yang transparan dan efektif. Laporan tahunan
              kami bertujuan untuk mengungkapkan kinerja, tujuan, serta rencana
              kami untuk mencapai target dan komitmen dalam mewujudkan potensi
              minyak kelapa sawit dalam satu tahun terakhir. Kami menyediakan
              pandangan bagaimana nilai-nilai kami mendorong tujuan strategis
              dan kemudian, bagaimana tindakan kami menciptakan nilai untuk
              perusahaan dan berbagai pemangku kepentingan. Laporan berikut ini
              mencakup informasi dan data mengenai aktivitas perusahaan untuk
              setiap periode yang disajikan.
            </p>
          </div>
          <div class="file">
          <table>
